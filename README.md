...
I am a Computer Science student at **Southern New Hampshire University** (Class of 2026) specializing in **Information Security**. My background includes hands-on experience in threat detection, network analysis, and security automation.
...
* **[Network Traffic Analysis (SYN Flood)](link-to-repo):** Analyzed packet captures using **tcpdump** to identify a SYN Flood DoS attack. Documented the TCP three-way handshake failure and recommended firewall rate-limiting rules.
* **[Phishing & Ransomware Response](link-to-repo):** Documented a multi-stage response to a healthcare ransomware incident. Analyzed malicious file hashes via **VirusTotal** and followed SOC playbooks to escalate and remediate the threat.
* **[Brute Force Investigation](link-to-repo):** Investigated an HTTP brute-force attack on a web server. Analyzed how the attacker bypassed weak passwords to inject malicious JavaScript and recommended IAM hardening.

#### 📋 Risk Management & Compliance
* **[Botium Toys Security Audit](link-to-repo):** Performed a comprehensive risk assessment and compliance audit for an e-commerce company, aligning their security posture with **PCI DSS**, **GDPR**, and **SOC type 2** standards.
* **[NIST Risk Register & Assessment](link-to-repo):** Developed a professional risk register for a financial institution, calculating risk priority scores based on likelihood and severity for threats like Business Email Compromise (BEC).
* **[Vulnerability Assessment Report](link-to-repo):** Conducted a systematic review of a MySQL database server, identifying high-risk exfiltration paths and implementing a remediation strategy involving TLS encryption and MFA.
...
- 🔗 **Portfolio:** [Link to your website or other projects]
